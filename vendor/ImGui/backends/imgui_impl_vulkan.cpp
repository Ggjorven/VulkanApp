...
struct ImGui_ImplVulkan_Data
{
    ...
    VkPipeline                  Pipeline;           // pipeline for main render pass
...
bool ImGui_ImplVulkan_CreateFontsTexture(VkCommandBuffer command_buffer)
{
    ...
    // Create the Image:
    {
        ...
        info.format = VK_FORMAT_R8G8B8A8_UNORM; // Note(Jorben/ggjorven): Maybe change this to sRGB sometime? 
...
static void ImGui_ImplVulkan_CreateWindow(ImGuiViewport* viewport)
{
    ...
    const VkFormat requestSurfaceImageFormat[] = { VK_FORMAT_B8G8R8A8_UNORM, VK_FORMAT_B8G8R8A8_UNORM, VK_FORMAT_B8G8R8A8_UNORM, VK_FORMAT_B8G8R8A8_UNORM };
